...
const description = `We have raised $${totalRaised.toLocaleString()} for ${GAMES_JSON.length} games. 
${numUnfundedGames === 1 ? '1 game remains' : `${numUnfundedGames} games remain`} unfunded.`;
...
// Add after the button container in index.html
const searchContainer = document.createElement("div");
searchContainer.innerHTML = `
    <input type="text" id="search-input" placeholder="Search games...">
    <button id="search-btn">Search</button>
`;
document.getElementById("button-container").appendChild(searchContainer);
